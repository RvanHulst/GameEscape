    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-lg-4 col-xl-3">
          ...
          <p class="mb-0">Welcome we are a company that works hard so you as a customer can enjoy your games without having to go through a long and difficult installing proces.</p>
        </div>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3">
          ...
          <hr class="bg-white mb-2 mt-0 d-inline-block mx-auto w-25">
          <ul class="list-unstyled">
            <li><i class="fa fa-home mr-2"></i>GameEscape</li>
            <li><i class="fa fa-envelope mr-2"></i>GameEscape@gmail.com</li>
            <li><i class="fa fa-phone mr-2"></i>078 354 25 98</li>
            <li><i class="fa fa-print mr-2"></i>+31 078 364 98 12</li>
          </ul>
        </div>
