  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="<?php echo base_url() ?>assets/img/slider/kick.jpg" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="<?php echo base_url() ?>assets/img/slider/d2.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="<?php echo base_url() ?>assets/img/slider/boi.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="<?php echo base_url() ?>assets/img/slider/soldier.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="<?php echo base_url() ?>assets/img/slider/sonic.jpg" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
          <h5>Sonic Riders</h5>
